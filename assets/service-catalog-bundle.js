...
const CollapsibleDescription = ({ title, description, }) => {
    ...
    return (jsxRuntimeExports.jsxs(DescriptionWrapper, { children: [jsxRuntimeExports.jsx(ItemTitle, { tag: "h1", children: title }), jsxRuntimeExports.jsx(CollapsibleText, { expanded: isExpanded, children: description }), showToggleButton && (jsxRuntimeExports.jsxs(ToggleButton, { isLink: true, onClick: toggleDescription, children: [isExpanded
...
function useServiceFormSubmit(serviceCatalogItem, requestFields) {
...
function ServiceCatalogItemPage({ serviceCatalogItemId, baseLocale, hasAtMentions, userRole, organizations, userId, brandId, }) {
    ...
    const { submitServiceItemRequest } = useServiceFormSubmit(serviceCatalogItem, requestFields);
